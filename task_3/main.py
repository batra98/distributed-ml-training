...
def main():
    ...
    parser.add_argument(
        "--num-nodes", type=int, help="Total number of nodes in the distributed setup"
    )
    parser.add_argument(
        "--rank", type=int, help="Rank of the current node (starting from 0)"
    )
    args = parser.parse_args()

    if args.master_ip and args.num_nodes and args.rank is not None:
